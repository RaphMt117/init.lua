		...
		require("neo-tree").setup({
			...
			window = {
				...
				mappings = {
					...
					["f"] = "add_directory", -- also accepts the optional config.show_path option like "add". this also supports BASH style brace expansion.
					["x"] = "delete",
					["r"] = "rename",
					["b"] = "rename_basename",
					["Y"] = "copy_to_clipboard",
			...
			filesystem = {
				...
				-- oepn_default - netrw disabled, opening a directory opens neo-tree
